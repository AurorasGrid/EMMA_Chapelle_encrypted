...
def user_inputs_Chapelle_Moudon():
    ...
    input_parameters['EMS']['site_name'] = 'Chapelle_Moudon_small'
    ...
    if input_parameters['EMS']['self_cons']:
        ...
        input_parameters['EMS']['peak_prod'] = 72  # [kW]
    ...
    input_parameters['battery']['size'] = 40                   # Capacity [kWh]
    input_parameters['battery']['converter_power_limit'] = 20    # [kW] Limit: battery power converter
